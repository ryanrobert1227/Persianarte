  ...
  return (
    <Flex flexDirection={["column", props.reverse ? "row-reverse" : "row", props.reverse ? "row-reverse" : "row", props.reverse ? "row-reverse" : "row"]} justifyContent="space-between">
      ...
      <Flex flexDirection="column" width={["100%", "45%", "45%", "45%"]}>
        <Text textAlign={["center", "start", "start", "start"]} width="100%" mt="7%" fontFamily="Ibarra Real Nova" fontStyle="normal" fontWeight="700" fontSize="2.5em" color="#33323D" >{props.title}</Text>
        ...
        <ButtonsTemplate msg="Ver Mais" width="30%" />
      </Flex>
    </Flex>
  )
}
